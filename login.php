...
<body class="min-h-screen flex items-center justify-center font-sans relative">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-8 relative z-10">
        ...
        <div class="text-xl text-center text-dark mb-8 font-semibold">Login</div>
        <form action="process_login.php" method="POST">
            <div class="mb-4">
                <label class="block text-darkest mb-2 font-semibold" for="l_username_or_l_email">Email/Username</label>
            ...
            <div class="mb-6 relative">
                <label class="block text-darkest mb-2 font-semibold" for="l_password">Password</label>
        ...
        <p class="text-center text-gray-600">Don't have an account? <a href="signup.php" class="text-light hover:underline font-semibold">Register</a></p>
    </div>
    <script>
